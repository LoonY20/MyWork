...
describe('regExp1', function() {
  it('regExp1', function() {
    assert.deepEqual(regExp.regExp1('afb aqw ahb thf dfg'), ['afb', 'ahb']);
  });
});

describe('regExp2', function() {
  it('regExp2', function() {
    assert.deepEqual(regExp.regExp2('aba aca aea abba adca abea'), ['abba', 'adca', 'abea']);
  });
});

describe('regExp3', function() {
  it('regExp3', function() {
    assert.deepEqual(regExp.regExp3('aa aeb aqsa amma aha'), ['aqsa', 'amma']);
  });
});
...
describe('regExp15', function() {
  it('regExp15', function() {
    assert.deepEqual(regExp.regExp15('aa aba abba abbba abbbba abbbbba'), [
      'abba',
      'abbba',
      'abbbba',
    ]);
...
describe('regExp18', function() {
  it('regExp18', function() {
    assert.deepEqual(regExp.regExp18('a1a a2a a3a a4a a5a aba aca'), [
      'a1a',
      'a2a',
      'a3a',
      'a4a',
...
describe('regExp19', function() {
  it('regExp19', function() {
    assert.deepEqual(regExp.regExp19('a1a a22a a333a a4444a a55555a aba aca'), [
      'a1a',
      'a22a',
      'a333a',
      'a4444a',
...
describe('regExp20', function() {
  it('regExp20', function() {
    assert.deepEqual(regExp.regExp20('aa a1a a22a a333a a4444a a55555a aba aca'), [
      'aa',
      'a1a',
      'a22a',
      'a333a',
...
describe('regExpReplace23', function() {
  it('regExpReplace23', function() {
    assert.equal(
      regExp.regExpReplace23('ave a#a a2a a$a a4a a5a a-a aca'),
...
describe('regExp25', function() {
  it('regExp25', function() {
    assert.deepEqual(regExp.regExp25('aba aea aca aza axa a.a a+a a*a'), [
      'aba',
      'a.a',
      'a+a',
      'a*a',
...
describe('regExp26', function() {
  it('regExp26', function() {
    assert.deepEqual(regExp.regExp26('aba a3a aca a6a axa a7a a2a a5a'), [
      'a3a',
      'a6a',
      'a7a',
      'a5a',
...
describe('regExp27', function() {
  it('regExp27', function() {
    assert.deepEqual(regExp.regExp27('aba awa aca a6a axa ada asa afa'), [
      'aba',
      'aca',
      'ada',
      'afa',
...
describe('regExp28', function() {
  it('regExp28', function() {
    assert.deepEqual(regExp.regExp28('aba awa aca a6a aha ada aka afa'), [
      'aba',
      'awa',
      'aca',
      'ada',
...
describe('regExp29', function() {
  it('regExp29', function() {
    assert.deepEqual(regExp.regExp29('aFa awa aca a6a aha aYa aka afa'), [
      'aFa',
      'aca',
      'aYa',
      'afa',
...
describe('regExp30', function() {
  it('regExp30', function() {
    assert.deepEqual(regExp.regExp30('aFa awa axa a6a aha aea aka afa'), [
      'aFa',
      'awa',
      'a6a',
      'aha',
...
describe('regExp33', function() {
  it('regExp33', function() {
    assert.deepEqual(regExp.regExp33('aAXa aeffa aGha aza ax23a a3sSa'), [
      'aAXa',
      'aeffa',
      'aGha',
      'aza',
...
describe('regExp35', function() {
  it('regExp35', function() {
    assert.deepEqual(regExp.regExp35('ааа ббб ёёё ззз ййй ААА БББ ЁЁЁ ЗЗЗ  ЙЙЙ'), [
      'ааа',
      'ббб',
      'ззз',
      'ййй',
...
describe('regExp38', function() {
  it('regExp38', function() {
    assert.deepEqual(regExp.regExp38('aeeea aeea aea axa axxa axxxa'), [
      'aeeea',
      'aeea',
      'aea',
      'axa',
...
describe('regExp39', function() {
  it('regExp39', function() {
    assert.deepEqual(regExp.regExp39('aeeea aeea aea axa axxa axxxa'), [
      'aeea',
      'axa',
      'axxa',
      'axxxa',
...
describe('regExpReplace70', function() {
  it('regExpReplace70', function() {
    assert.equal(
      regExp.regExpReplace70('rtyy rtyy rtyy rtyy dftjjn dfyt sgglx'),
      'rtyy dftjjn dfyt sgglx',
    );
  });
});
